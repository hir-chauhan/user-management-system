        ...
        <div className="hidden md:flex flex-col justify-between p-8 bg-gradient-to-br from-primary/10 via-primary/5 to-background border-r">
          ...
          <div className="space-y-4 py-8">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Secure authentication, easy-to-use user tables, quick search and filtering, and complete user management from start to finish.
            </p>

          </div>

          <div className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} NexaAdmin Inc. All rights reserved.
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center p-6 sm:p-10">
          <CardHeader className="p-0 pb-6">
            <div className="md:hidden flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-base">NexaAdmin</span>
            </div>
